...
class Dog extends Animal{
    constructor(name, breed){
        // this.name = name;  // Error will come
        super(name);
        this.breed = breed;
    }
    sniff(){
...
console.log(animal1);  // Animal { name: 'gorilla' }
console.log(animal1.eat());  // gorilla is eating

console.log(someDog);  // Dog { name: 'someDog', breed: 'German shepherd' }
...
console.log(persianCat); // Cat { name: 'someCat', breed: 'Persian Cat' }
